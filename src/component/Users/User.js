  ...
  get display() {
    ...
    return (
        <tr>
          ...
          <td>{user.age}</td>
          <td>
            <button className="btn btn-info mx-2" onClick={() => this.props.editRow(user.id, true)}>Edit</button>
  ...
  get editingRow() {
    ...
    return(
      <tr>
        ...
        <td>
          <button className="btn btn-primary mx-2" onClick={()=> this.props.saveRow(user.id, valueName, valueAge, valueGender, false)}>Save</button>
